...
\noindent Herunder ses et sekvensdiagram for User Story 17-18 - Load. Her ses hvordan det ønskes at de forskellige moduler kommunikerer på tværs af systemet når bruger gemmer et save i databasen.
\begin{figure}[H]
\centering
...
\input{02-Body/Design/ViewDesign.tex}
\input{02-Body/Design/Design-GameController.tex}
\input{02-Body/Design/BackendDesign.tex}
\input{02-Body/Design/SoftwareDesignDAL.tex}
\input{02-Body/Design/Database-Design.tex}
