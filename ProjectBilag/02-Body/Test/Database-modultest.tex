...
Til test hvor der skal indsættes data i databasen oprettes der objekter af den korrekte type hvorefter DAL funktioner til indsættes kaldes. Korrektheden af de indsatte data kan herefter tjekkes med datastudies.
...
\begin{figure}[h]
\centering
\includegraphics[width = \textwidth]{02-Body/Images/DAL-Database/NewSave.png}
...
\begin{figure}[h]
\centering
\includegraphics[width = \textwidth]{02-Body/Images/DAL-Database/Lister.png}
\caption{}
\label{fig:}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width = \textwidth]{02-Body/Images/DAL-Database/KodeTilLæsning.png}
\caption{}
\label{fig:}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width = \textwidth]{02-Body/Images/DAL-Database/ConsoleOutput..png}
\caption{}
\label{fig:}
\end{figure}
...
\hline
 Test & Funktion & Forventet resultat & Observering & Vurdering(OK/Fail)\\\hline
 1 & GetRoomDescrip-tion(id) & Her forventes det at funktionen henter beskrivelsen fra den valgte rumId. & Funktionen henterbeskrivelsen korrekt og vi kan udskrive denne på konsolen. & OK \\ \hline
