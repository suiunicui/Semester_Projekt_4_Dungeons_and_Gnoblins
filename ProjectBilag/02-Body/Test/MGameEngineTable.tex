...
Nedestående præsenteres en fuld table for alle classes testet som 
led i Game Enginen. De vigtigste er GameController, CombatController,
Player/Room og DiceRoller. Dice Danner ``Core Mechanics'' for spillet.

Interessant nok ses her at GameController fejler sine test grundet er
...
I nogle tilfælde er det kan det være umuligt er lave troværdige tests, når
...
Her benyttes mock tests og dependency injectiosn til at sikre at DiceRoller 
klassen danner de samme outputs hver gang en test køres.
Derved kan alle senarier for Player klassen testest afhængigt at DiceRoller
bestemte output. 
...
Nedestående vises kort en resultatet for Game Engine test
når de alle køres vi visuel studio. Som det kan ses så er
alle testene succesfulde hvilket giver hvis garanti for at
game engine opføre sig som specificeret i kravspecifikationerne.
