...
Denne består af en bruger, som interagerer med systemet gennem Frontend-applikationen som skrives i WPF. States i denne applikation styres af Game Engine,
