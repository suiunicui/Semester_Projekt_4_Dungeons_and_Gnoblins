...
Throughout the projekt it became clear from early interations that early integration 
between the projects four main branches, frontend, game engine, backend and database would be
critical for success as it simplified the integration, when doing many small interations
