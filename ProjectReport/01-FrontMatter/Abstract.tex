...
\begin{abstract}
  ...
  Gennem projektet blev det klart fra starten, at tidlig integration mellem projektets fire grene, frontend,
  game engine, backend og database, var kritisk for projektets succes. Dette skyldes at processen når mange
  små ændringer integreres i projektet, er simplere end proceseen der skal til at integrere store ændringer. Selvom projektet ikke har brugt fuldt automatiseret continuous integration har hyppig testning af det integrerede system sikret at afvigelser mellem individuelle moduler ikke voksede til en størrelse som gjorde dem uoverskuelige at løse. Den hyppige integration har også hurtigt givet os et grundlæggende system, som alle efterfølgende moduler kunne bygges ovenpå. Dette medførte at alle efterfølgende moduler, som nødvendigvis virkede med basen (som de var bygget på) integrerede nemt med hverandre.
  ...
  Slutproduktet er således en gennemtestet prototype af et spil, der med tiden kunne være blevet et fuldt udbygget
